...
from src.activities.attract_mode import AttractMode
...
class Window(pyglet.window.Window):
    def __init__(self):
        ...
        self._current_activity = AttractMode(self._painter)
    ...
    def on_state_update(self, dt):
        ...
        # Add previous call's residual dt.
        dt += self._residual_dt

        # It is possible for the dt to be very large due to events which cause a lag spike.
    ...
    def on_state_update_step(self, dt):
        ...
        if isinstance(self._current_activity, AttractMode) and retval:
